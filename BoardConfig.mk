...
# Assert
TARGET_OTA_ASSERT_DEVICE := krillin,krillin
...
# RIL
BOARD_RIL_CLASS := ../../../device/bq/krillin/ril/
...
BOARD_CUSTOM_BOOTIMG_MK := device/bq/krillin/bootimg.mk
...
# Recovery
TARGET_RECOVERY_FSTAB := device/bq/krillin/rootdir/recovery.fstab
...
# Selinux
BOARD_SEPOLICY_DIRS += device/bq/krillin/sepolicy
